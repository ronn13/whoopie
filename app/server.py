...
def api_config():
    return jsonify({
        "models": [
            ...
            {
                "slot": 2,
                "model_id": "exp12_ensemble" if MODEL_2_URL else None,
                "display_name": "EXP-12 Ensemble (RoBERTa + Longformer)" if MODEL_2_URL else "Model 2",
                "local": False,
                "url": MODEL_2_URL or None,
            },
            {
                "slot": 3,
                "model_id": "theophilus_aviation_classifier" if MODEL_3_URL else None,
                "display_name": "NER Causal Classifier" if MODEL_3_URL else "Model 3",
                "local": False,
